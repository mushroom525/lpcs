<?php if (!defined('THINK_PATH')) exit();?><html xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <script type="text/javascript" src="/wxmall/Public/js/ajax_tree.js"></script>
    <script type="text/javascript" charset="utf-8" src="/wxmall/Public/layer/layer.js"></script>
    <style type="text/css">
        <!--
        body {background: #fcfdff}
        -->
    </style>
    <link rel="stylesheet" type="text/css" href="/wxmall/Public/css/jqtreetable.css"></head>
<body>
<div id="rightTop">
    <p>商品分类</p>
    <ul class="subnav">
...
<div class="info2">
    <table class="distinction" style="font-size: 12px">
        ...
        <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$item): ?><tr style="background: rgb(255, 255, 255);">
            ...
            <td class="node" width="50%"><img src="/wxmall/Public/images/tv-expandable.gif" ectype="flex" status="open" fieldid="<?php echo ($item["cate_id"]); ?>"><span class="node_name" ectype="inline_edit" fieldname="cate_name" fieldid="<?php echo ($item["cate_id"]); ?>" required="1"><?php echo ($item["cate_name"]); ?></span></td>
            ...
            <td class="align_center"><?php if($item['if_show'] == 1): ?><img src="/wxmall/Public/images/positive_enabled.gif" ectype="inline_edit" fieldname="if_show" fieldid="<?php echo ($item["cate_id"]); ?>" fieldvalue="1"/><?php else: ?><img src="/wxmall/Public/images/positive_disabled.gif" ectype="inline_edit" fieldname="if_show" fieldid="<?php echo ($item["cate_id"]); ?>" fieldvalue="1"></td><?php endif; ?>
